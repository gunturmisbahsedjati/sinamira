...
if (in_array(1, $arrayAkses) || in_array(2, $arrayAkses)) {
    if (isset($_POST['addActivity']) && isset($_POST['_token'])  && isset($_POST['_key'])) {
        ...
        // $cekUndangan = isset($_POST['cek-surat-undangan']) ? 1 : 0;
        // $cekSK = isset($_POST['cek-sk']) ? 1 : 0;
        // $cekPanduan = isset($_POST['cek-panduan']) ? 1 : 0;
        // $cekST = isset($_POST['cek-st']) ? 1 : 0;
        // $cekDH = isset($_POST['cek-dh']) ? 1 : 0;
        // $cekNotula = isset($_POST['cek-notula']) ? 1 : 0;
        // $cekHK = isset($_POST['cek-hk']) ? 1 : 0;
        // $cekDok = isset($_POST['cek-dok']) ? 1 : 0;
