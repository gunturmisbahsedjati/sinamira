...
if (mysqli_num_rows($cekArea) > 0 && $level == 1 || $level == 2) {
    ...
    <div class="row mb-2">
        ...
        <div class="col-6">
            <div class="float-right">
                <a href="instrumentList?_token=<?= encrypt($thn) ?>" class="btn btn-warning btn-sm"><i data-feather="arrow-left"></i> Kembali</a>
            </div>
        </div>
    </div>
    <div class="card">
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="word-wrap:break-word;white-space:normal">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" title="Klik untuk mengisi capaian" data-toggle="modal" data-target="#addInstrumentAdmin" data-id="<?= encrypt($showProgram['id_program']) ?>"><i data-feather="search"></i> Capaian</button>
                                </td>
