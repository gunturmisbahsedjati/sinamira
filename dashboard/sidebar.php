        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                ?>
                    ...
                    <li class="pc-item">
                        <a href="#" data-toggle="modal" data-target="#commingSoon" class="pc-link "><span class="pc-micon"><i data-feather="file"></i></span><span class="pc-mtext">Export Laporan</span></a>
                    </li>
                    <!-- <li class="pc-item">
